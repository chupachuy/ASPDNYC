    ...
    $.fn.circliful = function (options, callback) {
        ...
        return this.each(function () {
            ...
            if (settings.targetPercent > 0 && settings.halfCircle !== true) {
                ...
                //elements += '<text text-anchor="middle" x="' + percentageX + '" y="110" style="font-size: ' + settings.targetTextSize + 'px;" fill="' + settings.targetColor + '">' + settings.targetPercent + (settings.noPercentageSign && settings.replacePercentageByText === null ? '' : '%') + '</text>';
            ...
            if (settings.text !== null) {
                if (settings.halfCircle) {
                    if (settings.textBelow) {
                        ...
                        //elements += '<text text-anchor="middle" x="' + (settings.textX !== null ? settings.textX : '100' ) + '" y="' + (settings.textY !== null ? settings.textY : '110') + '" style="' + settings.textStyle + '" fill="' + settings.textColor + '">' + settings.text + '</text>';
                    }
                } else {
                    if (settings.textBelow) {
            ...
            if (settings.halfCircle) {
                ...
                circleContainer
                    ...
                    .append(
                    $('<svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 8 194 186" class="circliful">' +
                        ...
                        //'<tspan class="text">' + (settings.replacePercentageByText === null ? 0 : settings.replacePercentageByText) + '</tspan><br/>' +
                        //'<tspan class="text">' + (settings.replacePercentageByText2 === null ? 0 : settings.replacePercentageByText2) + '</tspan>' +
                        //'</text>'
                    )
                    );
            } else {
